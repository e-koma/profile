...
- 大規模トラフィックに対するサーバ負荷対策
  - AWS Summit Tokyo 2019の [登壇資料](https://pages.awscloud.com/rs/112-TZM-766/images/I3-04.pdf) のように、100万req/min以上の大規模トラッフィクが見込まれるランキング上位アプリのシステムにおいて、サーバ負荷対策を徹底的に行ってきました。また複数のシステムでOS/DB/アプリケーションチューニングの経験があり、多くの実績を残しています。
