...
- システムの非機能要件をリリース品質まで高めるアーキテクト能力
  - システム設計
    - クラウドシステム全体の設計からDevOpsを含めた開発フローを複数システムで構築してきた実績があります。新しい技術導入に関しては、必要に応じてPoC検証を取り入れ、机上理論と実運用におけるバランスを取ることができます。
    - クラウドネイティブ/コンテナネイティブなシステムを0から完全にコード管理された状態で構築することができます。
  - 品質向上
